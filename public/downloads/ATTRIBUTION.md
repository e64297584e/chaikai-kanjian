> 下文保留上游项目的完整来源说明。本发行包只提供 27 个右手网格；2,234 个网格等描述属于上游数据范围，不代表本包的下载内容。
> The upstream attribution below is preserved for provenance. This release distributes only 27 right-hand meshes; upstream dataset counts do not describe the contents of this package.
